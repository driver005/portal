...
export const GiftCardPublished = {
  args: {
    ...GiftCardRes,
    defaultCurrency: 'usd',
  },
...
export const GiftCardUnpublished = {
  args: {
    ...GiftCardRes,
    status: 'unpublished',
    defaultCurrency: 'usd',
...
export const GiftCardNoSubunitCurrency = {
  args: {
    ...GiftCardRes,
    defaultCurrency: 'krw',
  },
...
export const GiftCardThreeDigitSubunitCurrency = {
  args: {
    ...GiftCardRes,
    defaultCurrency: 'bhd',
  },
