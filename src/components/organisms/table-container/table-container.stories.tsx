    ...
    <div>
      ...
      <div className="flex items-start justify-between mt-xlarge">
        ...
        <p className="inter-small-regular text-grey-50 inline-block max-w-[440px]">
          Note that React Table does not work in storybook. Because of this pagination does not work
          in this example, you should instead use the reload button to simulate pagination.
        </p>
      </div>
    </div>
  );
